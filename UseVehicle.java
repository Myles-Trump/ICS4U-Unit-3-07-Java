  ...
  public static void main(final String[] args) {
    ...
    try {
      ...
      switch (whichVehicle.nextInt()) {
        case 1:
          while (userInputted != C3) {
            final Scanner userInput = new Scanner(System.in);
            System.out.print("\nWould you like to (input 1) change your ");
            System.out.print("cadence, (input 2) ring your bell, or (input 3)");
        ...
        case 2:
          ...
          while (userInputted1 != C4) {
            ...
            System.out.print("truck's speed, (input 3) cycle the air, or ");
            System.out.print("(input 4) exit?: ");
